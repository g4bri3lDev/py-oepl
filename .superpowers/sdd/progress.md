...
Final whole-branch review (opus): MERGE AFTER FIXES → 2 must-fixes applied (commit be62426): version bump 0.2.0, P0-5 tagtype hex-letter regression test. All other deferred findings triaged as post-merge follow-ups. 273 tests green. Branch fix/firmware-contract ready to merge.
